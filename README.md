...
3. The course Id's can be found by visiting each course's homepage and inspecting the URL. The highlighted portion is the class's Canvas course Id. Do this for all classes you wish to log and write out each value sperated by a comma in `COURSE_ID_LIST` in the `.env` file
<img src="readme-images/course-id-url.PNG" alt="course id URL" width="300"/>
...
<img src="readme-images/database-id-url.PNG" alt="database id URL" width="300"/>
