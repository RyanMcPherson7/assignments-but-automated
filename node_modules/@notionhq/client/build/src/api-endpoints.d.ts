 ...
 */
import { PaginatedList, PaginationParameters, Database, Page, ParentInput, PropertyValue, Block, BlockBase, User, UserBase, Filter, Sort, SearchSort, SearchFilter, InputPropertyValue, Property, ParentPageInput, PropertySchema, RichTextInput, UpdateBlock, UpdatePropertySchema, ExternalFileInput, EmojiInput, FileInput } from "./api-types";
...
export declare type PageIcon = FileInput | ExternalFileInput | EmojiInput;
export declare type PageIconInput = (DistributiveOmit<Exclude<PageIcon, FileInput>, "type"> & {
    type?: string;
}) | null;
export declare type PageCover = FileInput | ExternalFileInput;
export declare type PageCoverInput = (DistributiveOmit<Exclude<PageCover, FileInput>, "type"> & {
    type?: string;
}) | null;
...
export declare const pagesCreate: {
    ...
    readonly pathParams: readonly [];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["parent", "properties", "children", "icon", "cover"];
    readonly path: () => string;
};
...
export declare const databasesCreate: {
    ...
    readonly pathParams: readonly [];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["parent", "properties", "title", "icon", "cover"];
    readonly path: () => string;
};
...
export declare const databasesUpdate: {
    ...
    readonly pathParams: readonly ["database_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["properties", "title", "icon", "cover"];
...
export interface PagesUpdateParameters extends PagesUpdatePathParameters, PagesUpdateQueryParameters, PagesUpdateBodyArchiveParameter, PagesUpdateBodyParameters {
}
...
export declare const pagesUpdate: {
    ...
    readonly pathParams: readonly ["page_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["archived", "properties", "cover", "icon"];
